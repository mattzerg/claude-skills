# visual-richness audit — https://matteisn.com/

**Verdict**: `BOLD`  ·  **Recipes applied**: `9/10` (90%)
**Generated**: 2026-05-11T04:29:01.076918Z
...
| **R4** Animated gradient drop cap | ✅ | 3/3 | \.lede-cap\b|class=[\"']lede-cap, @keyframes\s+\w*shimmer|cap-shimmer |
...
| **R9** Editorial section ornament (§ on rule) | ✅ | 2/3 | \.ornament\b, content:\s*[\"']§|content:\s*[\"']\\00a7 |
| **R10** Editorial 'currently' sidebar callout | ✅ | 3/3 | \.opening-currently|class=[\"'][^\"']*currently, \boc-rubric\b|\boc-key\b|\boc-v |
