# visual-richness audit — https://zergai.com/solutions

**Verdict**: `EDITORIAL-LEAN`  ·  **Recipes applied**: `1/10` (10%)
**Generated**: 2026-05-10T09:05:34.796904Z

| Recipe | Applied | Hits | Notes |
|---|---|---|---|
| **R1** Full-bleed dark gradient band | ✅ | 2/3 | linear-gradient\([^)]+#0[0-9a-f]{5}, radial-gradient\([^)]+rgba\( |
