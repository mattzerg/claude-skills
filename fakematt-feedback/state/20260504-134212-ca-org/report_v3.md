...
_Reviewed 2026-05-04 13:57; 8 pages, 90 findings (deduped from 98, merged 8)._

**Severity:** P0=7 · P1=51 · P2=32 · site-wide=1
...
- The portrait image upload file input (triggered by 'Change Image' button) has no associated label, failing WCAG 4.1.2. Screen reader users cannot identify the purpose of this control, which blocks a core profile-editing task.
...
- _Merged from 8 per-page findings._
