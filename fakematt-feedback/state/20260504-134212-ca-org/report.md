...
_Reviewed 2026-05-04 13:52; 8 pages, 98 findings (0 rejected for missing provenance)._

**Severity:** P0=14 · P1=52 · P2=32

## If I only fix three things
- The page is missing a lang attribute on the html element, which is a serious accessibility violation flagged by axe. Screen readers rely on lang to determine pronunciation rules and voice characteristics. Without it, assistive technology cannot correctly interpret the content language, causing misreadings that make the interface unusable for non-sighted users.
  - **Fix:** Add lang='en' (or appropriate language code) to the html element: <html lang='en' style='--zerg-drawer-width: 0px;'>
- The page lacks a lang attribute on the root html element, violating WCAG 2.2 AA SC 4.1.2. Screen readers cannot correctly determine the document language, leading to incorrect pronunciation of content and reduced comprehension for users relying on assistive technology. This is a critical accessibility blocker.
  - **Fix:** Add lang="en" to the opening <html> tag. If the application serves multiple languages, set lang dynamically based on the user's locale or browser preference.
...
### P0 — accessibility
- **Where:** https://ca-org.fly.dev/employee-directory (`html`)
...
- **Finding:** The page lacks a lang attribute on the root html element, violating WCAG 2.2 AA SC 4.1.2. Screen readers cannot correctly determine the document language, leading to incorrect pronunciation of content and reduced comprehension for users relying on assistive technology. This is a critical accessibility blocker.
- **Fix:** Add lang="en" to the opening <html> tag. If the application serves multiple languages, set lang dynamically based on the user's locale or browser preference.
- **Provenance:** voice=`None` · principles=`p-0002`
...
### P0 — accessibility
- **Where:** https://ca-org.fly.dev/people/1001 (`html`)
- ![](/Users/mattheweisner/.claude/skills/fakematt-feedback/state/20260504-134212-ca-org/screenshots/people_1001_desktop.png)
- **Finding:** The page has no lang attribute on the <html> element, which prevents screen readers from announcing content in the correct language and blocks text-to-speech from selecting the appropriate voice. This is an axe 'serious' violation that fails WCAG 3.1.1.
- **Fix:** Add lang="en" (or the appropriate language code) to the <html> element: <html lang="en" style="--zerg-drawer-width: 0px;">
- **Provenance:** voice=`None` · principles=`p-0002`
...
- **Provenance:** voice=`None` · principles=`p-0002`, `p-0008`

### P0 — accessibility
- **Where:** https://ca-org.fly.dev/people/1032 (`html`)
- ![](/Users/mattheweisner/.claude/skills/fakematt-feedback/state/20260504-134212-ca-org/screenshots/people_1032_desktop.png)
- **Finding:** The <html> element is missing a lang attribute, which prevents screen readers from correctly pronouncing content and forces assistive technology to guess the document language. This is a WCAG Level A failure that blocks international users and screen reader users from correct page interpretation.
- **Fix:** Add lang="en" to the <html> element (or the appropriate ISO 639-1 language code if the application supports multiple languages).
- **Provenance:** voice=`None` · principles=`p-0002`
...
### P0 — accessibility
- **Where:** https://ca-org.fly.dev/people/adp_UK001 (`html`)
...
- **Finding:** The page is missing the lang attribute on the root <html> element, which is a critical accessibility failure. Screen readers cannot determine the document's language, causing incorrect pronunciation and text-to-speech failures for all content. This is flagged by axe-core as a serious violation.
- **Fix:** Add lang="en" to the <html> element. If the application serves multiple locales, set this dynamically based on user or org preference.
- **Provenance:** voice=`None` · principles=`p-0002`
...
### P0 — accessibility
- **Where:** https://ca-org.fly.dev/people/adp_TWN001 (`html`)
...
### P0 — accessibility
- **Where:** https://ca-org.fly.dev/people/adp_UK004 (`html`)
...
- **Finding:** The page has no lang attribute on the <html> element, causing screen readers to guess the language incorrectly. This is a critical WCAG AA violation that affects all assistive technology users.
- **Fix:** Add lang="en" to the <html> tag. This is a one-line fix that should be applied to the base template.
- **Provenance:** voice=`None` · principles=`p-0002`
...
- **Provenance:** voice=`None` · principles=`p-0011`
...
- **Provenance:** voice=`None` · principles=`p-0107`, `p-0108`
...
- **Provenance:** voice=`None` · principles=`p-0002`, `p-0100`
...
- **Provenance:** voice=`None` · principles=`p-0097`, `p-0111`
...
- **Provenance:** voice=`None` · principles=`p-0106`, `p-0008`
...
- **Provenance:** voice=`None` · principles=`p-0096`, `p-0107`
...
- **Provenance:** voice=`None` · principles=`p-0009`, `p-0107`
...
- **Provenance:** voice=`None` · principles=`p-0110`, `p-0107`
...
- **Provenance:** voice=`None` · principles=`p-0100`, `p-0107`
...
- **Provenance:** voice=`None` · principles=`p-0097`, `p-0086`
...
- **Provenance:** voice=`None` · principles=`p-0108`, `p-0050`

### P1 — accessibility
- **Where:** https://ca-org.fly.dev/people/1001 (`main.person-page`)
- ![](/Users/mattheweisner/.claude/skills/fakematt-feedback/state/20260504-134212-ca-org/screenshots/people_1001_desktop.png)
...
- **Provenance:** voice=`None` · principles=`p-0100`
...
- **Provenance:** voice=`None` · principles=`p-0058`, `p-0097`
...
- **Provenance:** voice=`None` · principles=`p-0110`
...
### P1 — accessibility
- **Where:** https://ca-org.fly.dev/people/1032 (`main.person-page`)
- ![](/Users/mattheweisner/.claude/skills/fakematt-feedback/state/20260504-134212-ca-org/screenshots/people_1032_desktop.png)
- **Finding:** The page contains two <main> landmarks — one wrapping the person-page content and another wrapping the broader .content container (axe-core violations: landmark-main-is-top-level, landmark-no-duplicate-main). Screen readers cannot determine which is the primary content region, causing navigation confusion.
- **Fix:** Remove the nested <main> landmark inside .person-page and use a <section> or <article> element instead. Ensure only one <main> landmark exists per page, wrapping the entire primary content area.
- **Provenance:** voice=`None` · principles=`p-0002`
...
- **Provenance:** voice=`None` · principles=`p-0097`
...
- **Provenance:** voice=`None` · principles=`p-0010`
...
- **Provenance:** voice=`None` · principles=`p-0022`
...
- **Provenance:** voice=`None` · principles=`p-0010`, `p-0061`

### P1 — accessibility
- **Where:** https://ca-org.fly.dev/people/adp_TWN001 (`h3[data-v-1db00057]`)
- ![](/Users/mattheweisner/.claude/skills/fakematt-feedback/state/20260504-134212-ca-org/screenshots/people_adp_TWN001_desktop.png)
...
- **Provenance:** voice=`None` · principles=`p-0107`, `p-0032`
...
- **Provenance:** voice=`None` · principles=`p-0111`, `p-0107`
...
- **Provenance:** voice=`None` · principles=`p-0107`, `p-0043`
...
- **Provenance:** voice=`None` · principles=`p-0108`, `p-0106`

### P1 — accessibility
- **Where:** https://ca-org.fly.dev/people/adp_UK004 (`h3.direct-reports-heading`)
- ![](/Users/mattheweisner/.claude/skills/fakematt-feedback/state/20260504-134212-ca-org/screenshots/people_adp_UK004_desktop.png)
- **Finding:** The 'Direct Reports' heading is an h3, but it appears after an h1 with no intervening h2, violating WCAG heading hierarchy rules. Screen reader users rely on heading structure to navigate content efficiently.
- **Fix:** Change 'Direct Reports' to h2, or insert an h2 parent heading (e.g., 'Team Structure') that groups 'Direct Reports' and any sibling sections logically.
- **Provenance:** voice=`None` · principles=`p-0002`
...
- **Provenance:** voice=`None` · principles=`p-0106`, `p-0073`
...
- **Provenance:** voice=`None` · principles=`p-0106`, `p-0108`
...
- **Provenance:** voice=`None` · principles=`p-recognition`
...
- **Provenance:** voice=`None` · principles=`p-0107`, `p-0110`
...
- **Provenance:** voice=`None` · principles=`p-0010`, `p-0106`
...
- **Provenance:** voice=`None` · principles=`p-0108`, `p-0110`
...
- **Provenance:** voice=`None` · principles=`p-0003`, `p-0100`
...
- **Provenance:** voice=`None` · principles=`p-0074`
...
- **Provenance:** voice=`None` · principles=`p-0071`, `p-0108`
...
- **Provenance:** voice=`None` · principles=`p-0071`, `p-0101`
...
- **Provenance:** voice=`None` · principles=`p-0110`, `p-0097`
...
- **Provenance:** voice=`None` · principles=`p-0096`, `p-0097`
...
- **Provenance:** voice=`None` · principles=`p-0093`, `p-0094`
...
- **Provenance:** voice=`None` · principles=`p-0085`
...
- **Provenance:** voice=`None` · principles=`p-0107`, `p-0111`
...
- **Provenance:** voice=`None` · principles=`p-0096`, `p-0093`
...
- **Provenance:** voice=`None` · principles=`p-0096`, `p-0086`
...
- **Provenance:** voice=`None` · principles=`p-0100`, `p-0003`
...
- **Provenance:** voice=`None` · principles=`p-0111`, `p-0096`
...
- **Provenance:** voice=`None` · principles=`p-0100`, `p-0011`
...
- **Provenance:** voice=`None` · principles=`p-0106`, `p-0072`
...
- **Provenance:** voice=`None` · principles=`p-0107`, `p-0076`
