...
- **Fix:** Audit all text in the board preview section. Replace beige (#E8DCC8 or similar) with a color that meets 4.5:1 against its background. For the 'Backlog 8' column header and similar elements, either darken the text to at least #6B5D4F or lighten the background. Run axe DevTools to verify all violations are resolved.
- **Provenance:** voice=`—` · principles=`p-0001`, `p-0095`
...
- **Provenance:** voice=`—` · principles=`p-0001`, `p-0011`
...
- **Provenance:** voice=`—` · principles=`p-0010`, `p-0097`
...
- **Provenance:** voice=`—` · principles=`p-0032`, `p-0107`
...
- **Provenance:** voice=`—` · principles=`p-0032`
...
- **Provenance:** voice=`—` · principles=`p-0108`, `p-0100`
...
- **Provenance:** voice=`—` · principles=`p-0097`, `p-0058`
...
- **Provenance:** voice=`—` · principles=`p-0010`, `p-0110`
...
- **Provenance:** voice=`—` · principles=`p-0106`, `p-0110`
...
- **Provenance:** voice=`—` · principles=`p-0107`, `p-0109`
...
- **Provenance:** voice=`—` · principles=`p-0060`, `p-0109`
...
- **Provenance:** voice=`—` · principles=`p-0086`
...
- **Provenance:** voice=`—` · principles=`p-0043`, `p-0033`
...
- **Provenance:** voice=`—` · principles=`p-0085`, `p-0096`
...
- **Provenance:** voice=`—` · principles=`p-0047`, `p-0100`
...
- **Provenance:** voice=`—` · principles=`p-0001`, `p-0093`
...
- **Provenance:** voice=`—` · principles=`p-0096`, `p-0099`
...
- **Provenance:** voice=`—` · principles=`p-0101`, `p-0110`
